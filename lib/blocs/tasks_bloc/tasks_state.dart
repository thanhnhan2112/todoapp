...
class TasksState extends Equatable {
  ...
  @override
  List<Object> get props => [pendingTasks,completedTasks,removedTasks,favoriteTasks,];
  ...
  factory TasksState.fromMap(Map<String, dynamic> map) {
    return TasksState(
      pendingTasks: List<Task>.from((map['allTasks'] as List<int>).map<Task>((x) => Task.fromMap(x as Map<String,dynamic>),),),
